...
<body class='bg-dark'>
  ...
  <div class="container my-5">
    <div class="card mx-auto" style="max-width: 700px;">
      <img src="/Pictures/car2.jpg" class="card-img-top" alt="Nissan Terra">
      <div class="card-body">
        <h3 class="card-title">Nissan Terra (2025)</h3>
        <p class="card-text">
        ...
        <ul class="list-group list-group-flush mb-3">
          ...
          <li class="list-group-item"><strong>Price:</strong> $18.00/day</li>
        </ul>

        <form action="<?= base_url('rent/submit') ?>" method="post">
          <?= csrf_field() ?> <!-- CSRF protection -->

          <input type="hidden" name="car_id" value="2"> <!-- Set car ID -->
